module.exports = {
  siteTitle: 'Sparsh Kapoor | Front End Developer | IOS Developer',
  siteDescription:
  ...
  name: 'Sparsh Kapoor',
  location: 'Ghaaziabad, India',
  email: 'sparshkapoor43@gmai.com',
  github: 'https://github.com/chandrikadeb7',
  twitterHandle: '@chandrikadeb7',
  socialMedia: [
    {
      name: 'GitHub',
      url: 'https://github.com/sparsh-007',
    },
    {
      name: 'Linkedin',
      url: 'https://www.linkedin.com/in/sparsh-kapoor-804618105/'
    },
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/sparsh_kapoor_sk/',
    },
    {
      name: 'Twitter',
      url: 'https://twitter.com/SparshK82132541',
    },
  ],
